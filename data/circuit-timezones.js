// IANA timezone for each F1 circuit (2026 calendar — verified live).
// Fallback: 'UTC' if a circuitId is missing.
export const CIRCUIT_TZ = {
  ...
  // Older / occasional circuits — kept for safety on calendar changes
